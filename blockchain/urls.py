...
urlpatterns = [
    url(r'^$', views.index),
    url(r'^initapp/$',views.initapp),
    url(r'^status/$', views.status),
    url(r'translist/$',views.translist),
    url(r'^transdetail/$', views.transdetail),
    url(r'^bank/$', views.bankidx),
    url(r'^bank/grantloan/(?P<orderid>[a-zA-Z0-9_]+)/$', views.grantloan),
    url(r'^bank/returnloan/(?P<orderid>[a-zA-Z0-9_]+)/$', views.returnloan),
    ...
    url(r'^logistics/updategeo/(?P<orderid>[a-zA-Z0-9_]+)/$',views.logistics_updategeo),
    url(r'^logistics/deliver/(?P<orderid>[a-zA-Z0-9_]+)/$', views.logistics_deliver),
    url(r'^manufacturer/$', views.manufacturer),
    url(r'^manufacturer/orderlist/$', views.manufacturer_orderlist),
    url(r'^manufacturer/deliver/(?P<orderid>[a-zA-Z0-9_]+)/$', views.manufacturer_deliver),
